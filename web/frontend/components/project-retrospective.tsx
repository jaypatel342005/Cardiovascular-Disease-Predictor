                     ...
                     <Card className="bg-blue-500/5 border-blue-500/20">
                       <CardContent className="pt-6">
                         <div className="flex items-center gap-2 mb-2">
                           ...
                           <h4 className="font-semibold text-blue-500">Goal</h4>
                         </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <Card className="md:col-span-1">
                      ...
                      <CardContent className="text-sm space-y-2">
                        <div className="p-2 bg-muted/30 rounded">RandomForest</div>
                        <div className="p-2 bg-muted/30 rounded">GradientBoosting</div>
                        <div className="p-2 bg-muted/30 rounded border-l-2 border-green-500 font-medium">XGBoost (Top Pick)</div>
                        <div className="p-2 bg-muted/30 rounded">StackingClassifier</div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="md:col-span-1">
                      ...
                      <CardContent className="text-sm space-y-2">
                        <div className="p-2 bg-muted/30 rounded">LogisticRegression</div>
                        <div className="p-2 bg-muted/30 rounded">LinearSVC</div>
                        <div className="p-2 bg-muted/30 rounded">CalibratedClassifierCV</div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="md:col-span-1">
                      ...
                      <CardContent className="text-sm space-y-2">
                        <div className="p-2 bg-muted/30 rounded">KNeighborsClassifier</div>
                        <div className="p-2 bg-muted/30 rounded">DecisionTreeClassifier</div>
                        <div className="p-2 bg-muted/30 rounded">GaussianNB</div>
                      </CardContent>
                    </Card>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-6">
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg flex justify-between">
                          <span>XGBoost Tuning</span>
                          <Badge>Selected</Badge>
                        </CardTitle>
                        <CardDescription>
                          <span className="flex gap-4 mt-1">
                            <span>Best 5-fold CV: 73.63%</span>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-2 text-sm">
                         ...
                         <div className="mt-4 p-3 bg-blue-500/10 text-blue-600 text-sm rounded-lg flex gap-2">
                    ...
                    <Card className="opacity-80">
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg">Random Forest Tuning</CardTitle>
                        <CardDescription>
                          <span className="flex gap-4 mt-1">
              ...
              {activeTab === "conclusion" && (
                <div className="space-y-6">
                   <div className="bg-gradient-to-br from-primary/10 to-transparent p-6 rounded-2xl border border-primary/20">
                    <h3 className="text-2xl font-bold mb-4 text-primary">7.0 Final Selection</h3>
                    <p className="text-lg leading-relaxed text-foreground">
                      The tuned <strong>XGBoost</strong> model identified as <code className="text-sm bg-background px-2 py-1 rounded border">best_xgboost_cvd_model.pkl</code> was selected for deployment.
                    </p>
